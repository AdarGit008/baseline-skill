...
// -> --config file -> --profile flags. Also derives the claims opt-in and active profiles.
...
export function resolveConfig(repo, { cliConfigPath = null, profileArgs = [] } = {}) {
  ...
  return { cfg, DEFAULTS, EXPLICIT, CLAIMS_ACTIVE, ACTIVE, SIGNOFF }
}
